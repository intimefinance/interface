export const UNI_LIST = 'https://raw.githubusercontent.com/intimefinance/intime-token-list/main/tokenlist.json'
export const UNI_EXTENDED_LIST =
  'https://raw.githubusercontent.com/intimefinance/intime-token-list/main/extended.tokenlist.json'
const UNI_UNSUPPORTED_LIST =
  'https://raw.githubusercontent.com/intimefinance/intime-token-list/main/unsupported.tokenlist.json'
...
export const DEFAULT_INACTIVE_LIST_URLS: string[] = [UNI_EXTENDED_LIST, ...UNSUPPORTED_LIST_URLS]
